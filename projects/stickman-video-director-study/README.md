...
在消耗视频生成额度前，Project 008 先完成了一轮只看角色外观的静态探索。专题页新增[形象扩展实验](https://yydshly.github.io/0828_codex_project/projects/stickman-video-director-study/#character-styles)，并用八张直接生成的 1:1 全身样张对照不同角色语言：

| 形象 | 核心优势 | 适合场景 | 主要连续性锚点 |
| --- | --- | --- | --- |
| 几何纸片人 | 最接近火柴人的动作语法，迁移成本最低 | 知识解释、产品流程、商业汇报 | 几何比例、关节数量 |
| 无脸时尚人物 | 品牌与编辑表现力高 | 品牌故事、职场、生活方式、时尚 | 发型、固定服装、人物比例 |
| 黏土小人 | 亲和、能容纳轻微形变 | 教育、轻科普、儿童、温暖品牌 | 头身比、发型体块、服装色块 |
| 毛毡玩偶 | 治愈感与材料记忆点强 | 心理健康、亲子、情感叙事 | 圆形轮廓、围巾、缝线 |
| 黑色剪影人物 | 轮廓稳定、情绪冲击强 | 概念、悬疑、压力、社会议题 | 长外套剪影、有限强调色 |
| 低多边形人物 | 保留三维空间与视角变化 | 科技产品、工业流程、游戏化教育 | 面片密度、服装和比例 |
| 木偶关节人 | 动作与关节最容易阅读 | 动作教学、分镜预演、创意实验 | 关节拓扑、木质材料 |
| 品牌吉祥物 | 最适合积累产品助手和内容 IP | 产品教程、AI 助手、品牌连载、社媒 | 胶囊轮廓、面板、触角与色板 |

图片清单、共享约束、逐项生成规格与证据边界记录在 [`character-style-gallery.json`](./experiments/character-style-gallery.json)。第一轮视频 A/B 建议只选择几何纸片人、黑色剪影、黏土小人和品牌吉祥物，它们分别代表最低迁移成本、最高轮廓稳定、最高亲和力和最高长期 IP 价值。

这组图片只能证明静态视觉方向可展示，不能证明视频动作、跨镜头身份一致性、成功率、成本或批量稳定性；本轮没有生成新视频。
